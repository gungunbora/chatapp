...
const ChatContainer = ({selectedUser,setSelectedUser}) => {
  ...
  return selectedUser ? (
    ...
    <div ref={scrollEnd}>
      ...
      {/* bottom area : send msg */}
   </div>
     <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
         <input type="text" placeholder='Send a message' class name ='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-400' />
